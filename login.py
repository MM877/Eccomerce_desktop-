...
def login_page():
    ...
    Button(frame1, text="Login", font=("Arial", 14, "bold"), bg="#4CAF50", fg="white",
           width=12, command=handle_login).place(x=90, y=220)

    Button(frame1, text="Clear", font=("Arial", 14, "bold"), bg="#f44336", fg="white",
           width=12, command=lambda: [username_entry.delete(0, END), password_entry.delete(0, END)]
           ).place(x=260, y=220)

    Button(frame1, text="Create Account", font=("Arial", 12), bg="white", fg="blue",
           command=open_register).place(x=180, y=280)
...
if __name__ == "__main__":
    ...
    if user_type == "admin":
        ...
        user_dashboard.categories_page()
